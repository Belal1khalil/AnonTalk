...
export default function HomePage() {
  return (
    <div className="bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900 transition-colors duration-300">
      {/* Hero Section */}
      <section className="relative overflow-hidden">
        {/* Background decorations */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-primary-200 dark:bg-primary-900 rounded-full blur-3xl opacity-30 animate-pulse"></div>
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-primary-300 dark:bg-primary-800 rounded-full blur-3xl opacity-20 animate-pulse delay-700"></div>
        </div>

        <div className="container relative">
          <div className="py-20 md:py-32 text-center max-w-4xl mx-auto">
            {/* Badge */}
            <div className="inline-flex items-center px-4 py-2 bg-primary-50 dark:bg-primary-900/30 rounded-full mb-8 animate-fade-in">
            ...
            {/* Main Heading */}
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-200 dark:to-white bg-clip-text text-transparent leading-tight">
              Share Your Thoughts
              <br />
      ...
      <section className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-primary-50 to-white dark:from-primary-950/50 dark:to-gray-800 border border-primary-100 dark:border-primary-900/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            {/* Feature 2 */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/50 dark:to-gray-800 border border-blue-100 dark:border-blue-900/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            {/* Feature 3 */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-purple-50 to-white dark:from-purple-950/50 dark:to-gray-800 border border-purple-100 dark:border-purple-900/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            {/* Feature 4 */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-green-50 to-white dark:from-green-950/50 dark:to-gray-800 border border-green-100 dark:border-green-900/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            {/* Feature 5 */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-white dark:from-orange-950/50 dark:to-gray-800 border border-orange-100 dark:border-orange-900/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            {/* Feature 6 */}
            <div className="group p-8 rounded-2xl bg-gradient-to-br from-pink-50 to-white dark:from-pink-950/50 dark:to-gray-800 border border-pink-100 dark:border-pink-900/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
      ...
      <section className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Testimonial 1 */}
            <div className="p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
            ...
            <div className="p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-semibold text-gray-900 dark:text-white">Michael K.</div>
            ...
            <div className="p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-semibold text-gray-900 dark:text-white">Emma L.</div>
      ...
      {/* Final CTA Section */}
      <section className="py-20 bg-gradient-to-br from-primary-50 via-white to-primary-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 transition-colors duration-300">
        <div className="container">
